public class Camioneta extends Vehiculo {
  public Camioneta(double costoProduccion, String modelo, String descripcion) {
  ...
  public double calcularUtilidad() {
    return super.getCostoProduccion() * 1.8;
  }

  @Override
  public double calcularImportacion() {
    return (super.getCostoProduccion() + super.getUtilidad()) * 0.15;
  }
}

public class Lujo extends Vehiculo {
  public Lujo(double costoProduccion, String modelo, String descripcion) {
  ...
  public double calcularUtilidad() {
    return super.getCostoProduccion() * 1.5;
  }

  @Override
  public double calcularImportacion() {
    return (super.getCostoProduccion() + super.getUtilidad()) * 0.1;
  }
}
